...
def get_args():
    ...
    parser.add_argument("-i", "--image", type=str, default="test_images/12-7942.jpg", help="path to test image")
    parser.add_argument("-s", "--size", default=416, type=int)
    parser.add_argument("-t", "--conf_threshold", default=0.6, type=float)
    parser.add_argument("-c", "--checkpoint", type=str, default="trained_models/last_model.pt",
...
def test(args):
    ...
    # classification thường resize ntn nhưng object detection thì k vì ko giữ đc aspect ratio
